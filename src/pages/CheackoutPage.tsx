        ...
        return (
            <div className="bg-white">
                <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-0">
                    <h1 className="text-3xl font-extrabold text-center tracking-tight text-gray-900 sm:text-4xl">Checkout From</h1>
                    <div className="mt-12">
                        <p className="text-center text-sm font-medium text-gray-500">
                            Empty Cart <a href="#" className="text-indigo-600 hover:text-indigo-500">Go shopping</a>.
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div className="relative z-10 bg-white border-t border-gray-200 px-4 sm:px-6">
                                <div className="max-w-lg mx-auto">
                                    <Popover.Button className="w-full flex items-center py-6 font-medium">
                                        ...
                                        <span className="text-base mr-2">${totalPrice}</span>
